...
class AppStyles {
  ...
  static const TextStyle twelveRegularMain = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w400, color: mainTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle twelveRegularSecond = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w400, color: secondTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle twelveBoldMain = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w700, color: mainTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle twelveBoldSecond = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w700, color: secondTextColor, fontFamily: 'InterFigmaFont');

  // 16px font size
  static const TextStyle sixteenRegularMain = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w400, color: mainTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle sixteenRegularSecond = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w400, color: secondTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle sixteenBoldSecond = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w700, color: secondTextColor, fontFamily: 'InterFigmaFont');
  static const TextStyle sixteenBoldMain = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w700, color: mainTextColor, fontFamily: 'InterFigmaFont');

  static const TextStyle cardTagLineStyle = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w400, color: secondTextColor, letterSpacing: -1, fontFamily: 'InterFigmaFont');
